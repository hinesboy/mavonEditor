# mavonEditor-fa
![npm](https://nodei.co/npm/mavon-editor-fa.png?downloads=true&downloadRank=true&stars=true)

> A markdown editor based on Vue

### forked from [mavonEditor](https://github.com/hinesboy/mavonEditor)
...
- Available through [markdown-it](./doc/cn/markdown.md) Object introduction [Other syntax plugins](https://www.npmjs.com/search?q=keywords:markdown-it-plugin)

## Collaborators

- [CHENXCHEN](https://github.com/alirezamires)
