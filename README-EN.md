**Note: In order to reduce the component size, the 1.7.5 version separates hightlight.js and katex from the component, the component size decreases from 900k to about 255k. If you need to use these two functions，reference API**
