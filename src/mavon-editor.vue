  ...
  >
    ...
    >
      <v-md-toolbar-left
        ...
        @imgTouch="$imgTouch"
      >
        <template #left-toolbar-before><slot name="left-toolbar-before" /></template>
        <template #left-toolbar-after><slot name="left-toolbar-after" /></template>
      </v-md-toolbar-left>
      <v-md-toolbar-right
        ref="toolbar_right"
        :d_words="d_words"
        ...
        :s-full-screen="s_fullScreen"
        :s_html_code="s_html_code"
        :s_navigation="s_navigation"
        :class="{ transition: transition }"
        @toolbar_right_click="toolbar_right_click"
      >
        <template #right-toolbar-before><slot name="right-toolbar-before" /></template>
        <template #right-toolbar-after><slot name="right-toolbar-after" /></template>
      </v-md-toolbar-right>
    </div>
    <!--编辑展示区域-->
      ...
      <div ref="help">
        ...
        >
          ...
          >
            ...
            />
            <div class="scroll-style v-note-help-show" v-html="d_help" />
          </div>
        </div>
      </div>
    </transition>
